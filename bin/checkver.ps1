...
function Register-PreludeFnGetUrlRedirectLocation {
    <#
    .SYNOPSIS
    Retrieves the final URL after following any HTTP redirects.
    .PARAMETER Uri
    The initial URL to check for redirects.
    .PARAMETER MaximumRedirection
    The maximum number of redirects to follow. Default is 0 (prevent all redirects).
    .OUTPUTS
    System.String
    The final URL after following redirects.
    .NOTES
    This function is intended to be used within the prelude of checkver.script.
    #>
    param(
    ...
    return (Invoke-WebRequest @requestArgs).Headers['Location']
}
...
function Get-CheckverScriptPrelude() {
    return @(
        ...
        # - `Get-UrlRedirectLocation`: get redirect location of a URL
        '$page = $using:page',
        '${function:Get-UrlRedirectLocation} = ${using:function:Register-PreludeFnGetUrlRedirectLocation}'
    )
}
